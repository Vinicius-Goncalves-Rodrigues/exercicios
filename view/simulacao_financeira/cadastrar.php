...
if(isset($_POST['cliente'])){
   ...
   $valor = $valor_bem/$numero_parcelas;

   $Controller->Cadastrar($_POST['cliente'], $_POST['data_hora'], $valor_bem, $taxa, $numero_parcelas);
}
if(isset($numero_parcelas)){
   echo "valor : $_POST[valor_bem]";
   echo "<br>";
   echo "valor: $valor";
}
